...
test('test calculate profit and loss is working correctly with flat rates', () => {
	/**
...
test('test calculate profit and loss is working correctly with gains', () => {
	/**
...
test('test calculate profit and loss is working correctly with losses and varying rates', () => {
	/**
	 * NOTE this unit test assumes interest accrues at 10% daily interest
	 * so you take a loan of 11 at a rate of 1 ($11) and this generates 10% interest
...
test('test calculate profit and loss is working correctly with liquidations', () => {
	/**
	 * NOTE this unit test assumes interest accrues at 10% daily interest
	 * so you take a loan of 11 at a rate of 1 ($11) and this generates 10% interest
	 * so a day later you owe 12.1, and then you pay back 2.1 at a rate of 1.5 = $3.15
